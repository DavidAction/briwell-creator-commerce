...
3. **C slimmed down (code, in order)**: (a) ~~creator_provided submission channel~~ — DONE 2026-07-08 (briefing 0.0.12); (b) news-RSS panel on the existing discovery screen (needs a small backend fetcher); (c) full trend tab only after real data flows. Full-tab design notes in briefing 0.0.8; the 0.0.8 mockup was never committed.
